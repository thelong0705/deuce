...
// defaultTestDSN points at a database of the tests' own. These tests write
// freely and never clean up, so they must not run against the one the server
// uses. Override with TEST_DB_URL.
